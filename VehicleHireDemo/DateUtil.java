...
public class DateUtil
{
   ...
   public static void setshortDatePattern(String newPattern) 
   {
	   shortDatePattern = newPattern;
   }
   
   public static void setlongDatePattern(String newPattern)
   {
	   longDatePattern = newPattern;
   }
